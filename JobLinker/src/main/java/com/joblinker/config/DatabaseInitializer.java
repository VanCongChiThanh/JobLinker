...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (countPermissions == 0) {
            ...
            arr.add(new Permission("Update a company", "/api/v1/companies/{id}", "PUT", "COMPANIES"));
            ...
            arr.add(new Permission("Update a job", "/api/v1/jobs/{id}", "PUT", "JOBS"));
            ...
            arr.add(new Permission("Update a resume", "/api/v1/resumes/{id}", "PUT", "RESUMES"));
            ...
            arr.add(new Permission("Update a subscriber", "/api/v1/subscribers/{id}", "PUT", "SUBSCRIBERS"));
        ...
        if (this.roleRepository.findByName("EMPLOYER") == null) {
            ...
            employerRole.setPermissions(allPermissions.stream()
                    .filter(permission -> permission.getModule().equals("COMPANIES") ||
                            permission.getModule().equals("JOBS"))
            ...
            employerRole.getPermissions().addAll(allPermissions.stream()
                    .filter(permission -> (permission.getModule().equals("COMPANIES") || permission.getModule().equals("JOBS"))
                            && (permission.getMethod().equals("POST") ||
